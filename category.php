...
<section class="products">
 ...
 <form action="" method="post" class="box">
      ...
      <a href="" class="option-btn" style="background: linear-gradient(120deg, #e0c3fc 0%, #8ec5fc 100%); color:#000; border-radius:3rem;"><i class="fa fa-play-circle" aria-hidden="true"></i> Play </a>
